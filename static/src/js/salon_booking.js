odoo.define('myhealth.website_salon_booking_system', function (require) {
'use strict';
                ...
                if (name != "" && phone != "" && email != "" && service != "" && chair != ""){
                   ...
                   $.ajax({
                    ...
                    success: function( data ) {
                        window.location.href = "/page/myhealth.salon_booking_thank_you";
                    },
...
$(document).on('click',"#check_button",function() {
   ...
   if (check_date != "")
       ...
       var salon_check_date = ajax.jsonRpc("/page/salon_check_date", 'call', {'check_date':check_date })
                    ...
                    window.location= "/page/myhealth.salon_booking_form?x=" + date_info
                 })
       }
   else
       {
