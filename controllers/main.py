...
class SalonBookingWeb(http.Controller):
    ...
    @http.route('/page/myhealth.salon_booking_thank_you', type='http', auth="public", website=True)
    def thank_you(self, **post):
        return request.render('myhealth.salon_booking_thank_you', {})

    @http.route('/page/myhealth.salon_booking_form', type='http', auth="public", website=True)
    def chair_info(self, **post):
        ...
        return request.render('myhealth.salon_booking_form',
